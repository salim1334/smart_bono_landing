      ...
      <div className="relative overflow-hidden rounded-[2rem] gradient-burgundy text-background p-12 md:p-16 shadow-glow">
        ...
        <div className="relative max-w-2xl">
          <h2 className="font-display text-4xl md:text-5xl font-bold leading-tight">
            Ready to bring Smart bono to your cafe?
          </h2>
          <p className="mt-4 text-background/85 text-lg">
            Talk to the Alarm Technology team. We'll set you up with the right tier, train your staff
            and get your first receipt printing today.
          </p>
