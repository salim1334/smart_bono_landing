...
export const dictionaries = {
  en: {
    ...
    pricing: {
      ...
      save: ["", "Save up to 33%", "Save up to 50%"],
      ...
      tiersLabel: {
        ...
        Full: "Hybrid (Without Food ingredients stock management)",
        Hybrid: "Hybrid (With Food ingredients stock management)",
      },
      tiersAm: {
        Entry: "ኦፍላይን መደበኛ",
        Professional: "ኦፍላይን ከፍተኛ",
        Full: "ሃይብሪድ (የምግብ ግብዓቶች ክምችት ቁጥጥር ሳይኖር)",
        Hybrid: "ሃይብሪድ (የምግብ ግብዓቶች ክምችት ቁጥጥር ጋር)",
      },
      tiersTag: {
        Entry: "Essential offline waiter tracking",
        Professional: "Adds cashflow management",
        Full: "Ingredients, inventory & multi-device",
        Hybrid: "Cloud sync, remote analytics & multi-branch",
      },
      tiersFeat: {
        Entry: [
          "Offline-first POS",
  ...
  am: {
    ...
    pricing: {
      ...
      tiersTag: {
        ...
        Full: "ጥሬ እቃ፣ እቃ ቤት እና ባለ ብዙ መሳሪያ ድጋፍ ተጨማሪ",
        Hybrid: "ክላውድ ማስተሳሰር፣ የቀጥታ ትንታኔ እና ለብዙ ቅርንጫፎች",
      },
      tiersFeat: {
        Entry: [
          "ያለ ኢንተርኔት የሚሰራ ቦኖ",
